...
## Revisión 49 | Actualizado: 05 Jul 2026
...
|**BAJA R13 extendida** MC/AM del favorito no anota en KO|2/8 histórico + P44 (Rodríguez no anota ni asiste) + P45 (De Paul/Enzo/Mac Allister no anotan, pero Mac Allister sí asiste) + P46 (Ounahi, MC del favorito, anota un DOBLETE — el contraejemplo más dañino de la regla hasta la fecha) + **P47 (Rabiot y Manu Koné, MC titulares de Francia, no anotan — primer caso de apoyo tras el contraejemplo de Ounahi)**|★ máximo o sin apuesta en gol; el caso de apoyo de P47 corta la racha de contraejemplos pero no basta por sí solo para reconsiderar el nivel BAJA|
|**MEDIA R40 (matizada 3 veces)** Gol del equipo inferior desde perfil inesperado|5/5 en ámbito (patrón general); 0/2 en aplicaciones reales como pick individual; sin caso evaluable en P41-P44; P45 requirió corrección (autogol, no gol genuino de Cabral). **Sin caso evaluable en P46** (el equipo inferior, Canadá, no anotó)|Eliminar el prop individual de las recomendaciones ★. Usar solo el mercado colectivo o BTTS Sí como proxy|
...
|**BAJA R38 (BAJA obligatoria, 3ª redefinición, 2/3 partidos limpios)** Supresión/proyección de corners en R32|Falló en 3 partidos consecutivos antes de P41; P41 y P42 sin fallo mayor; P43, P44, P46 y ahora **P47 no computan formalmente (mercado no proyectado activamente en R32; P46 y P47 además son R16, fuera de ámbito estricto), pero el resultado real de P47 (14 corners) vuelve a ser informativamente alto**|No usar como ★★★ ni ★★ hasta sobrevivir 3 partidos consecutivos con el mercado activamente proyectado y sin fallo|
